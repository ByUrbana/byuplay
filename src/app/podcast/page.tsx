...
export default function PodcastPage() {
  ...
  // Carregar vídeos do gênero podcast
  useEffect(() => {
  ...
  return (
    <main className="podcast-skin min-h-screen pb-24">
      ...
      <section className="relative">
        <div className="pointer-events-none absolute -top-20 -left-20 h-60 w-60 rounded-full bg-purple-400/15 blur-3xl" />
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                <div className="text-white/60 mb-4">
                  Nenhum vídeo de podcast encontrado
                </div>
                <Link
                  href="/catalogo"
                  className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold border border-purple-400/50 bg-purple-400/20 text-purple-100 hover:bg-purple-400/30 hover:border-purple-400/70 transition-all duration-300"
                >
