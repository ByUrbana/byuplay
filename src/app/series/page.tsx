...
const SLIDES: Slide[] = [
  {
    tag: "BY)))U SERIES",
    body: "Descubrí las mejores series del momento con BY)))U SERIES. Desde dramas intensos hasta comedias que te harán reír 👉 Explorá nuestro catálogo",
    strong: ["mejores series", "dramas intensos", "comedias", "catálogo"],
  },
  {
    tag: "BY)))U SERIES",
    body: "Sumergite en mundos increíbles con nuestras series exclusivas. Historias que te mantendrán en vilo hasta el último capítulo 👉 Comenzá a ver ahora",
    strong: ["mundos increíbles", "series exclusivas", "historias", "último capítulo"],
  },
  {
    tag: "BY)))U SERIES",
    body: "Desde thrillers psicológicos hasta ciencia ficción épica. En BY)))U SERIES encontrás la serie perfecta para cada momento 👉 Descubrí tu próxima obsesión",
    strong: ["thrillers psicológicos", "ciencia ficción épica", "serie perfecta", "próxima obsesión"],
  },
  {
    tag: "BY)))U SERIES",
    body: "Bingewatching de calidad con BY)))U SERIES. Maratones interminables de las series más adictivas del momento 👉 Prepará las palomitas",
    strong: ["bingewatching de calidad", "maratones interminables", "series más adictivas", "palomitas"],
  },
];
...
function highlightBody(text: string, strong: string[] = []) {
  ...
  const specialNeedles = [
    ...
    { text: "SERIES", className: "font-black", color: AZUL },
  ];

  if (text.includes("BY)))U SERIES")) {
    const parts = text.split("BY)))U SERIES");
    return (
      <>
        {parts[0]}
        <Image
    ...
    <main className="series-skin min-h-screen pb-24">
      ...
      >
        <video
          ...
          preload="auto"
        >
          <source src="/video/series-bg.mp4" type="video/mp4" />
        </video>
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(120%_70%_at_50%_0%,rgba(59,130,246,.2),transparent_60%)]" />
          ...
          <article className="rounded-2xl p-4 bg-transparent shadow-none">
            <div className="relative h-36 md:h-44 rounded-xl overflow-hidden mb-3">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center">
                <span className="text-white font-bold text-2xl">SERIE 1</span>
              </div>
            ...
            <p className="text-sm text-white/80">Drama • 8 episodios</p>
          </article>
          ...
          <article className="rounded-2xl p-4 bg-transparent shadow-none">
            <div className="relative h-36 md:h-44 rounded-xl overflow-hidden mb-3">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 to-indigo-800 flex items-center justify-center">
                <span className="text-white font-bold text-2xl">SERIE 2</span>
              </div>
              <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-black/35 to-transparent" />
            </div>
            <h3 className="font-semibold text-white">
            ...
            <p className="text-sm text-white/80">Sci-Fi • 12 episodios</p>
          </article>
          ...
          <article className="rounded-2xl p-4 bg-transparent shadow-none">
            <div className="relative h-36 md:h-44 rounded-xl overflow-hidden mb-3">
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-600 to-cyan-800 flex items-center justify-center">
                <span className="text-white font-bold text-2xl">SERIE 3</span>
              </div>
              <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-black/35 to-transparent" />
            </div>
            <h3 className="font-semibold text-white">
            ...
            <p className="text-sm text-white/80">Comedia • 6 episodios</p>
          </article>
        </div>
      </section>
    </main>
