...
export default function UploadVideoPage() {
  ...
  const [uploadMethod, setUploadMethod] = useState<"direct" | "traditional">(
    "direct"
  );
  ...
  const handleDirectUploadSuccess = (videoData: any) => {
    console.log("Upload directo exitoso:", videoData);
    alert("¡Video subido con éxito directamente a Cloudinary!");
    router.push("/dashboard");
  };

  const handleDirectUploadError = (error: string) => {
    console.error("Error en upload directo:", error);
    alert(`Error en upload directo: ${error}`);
  };

  const handleDirectUploadProgress = (progress: number) => {
            ...
            <div className="relative">
              ...
              <div className="mb-6 p-4 rounded-xl border border-white/10 bg-white/5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border transition-all opacity-60 cursor-not-allowed ${
                  ...
                  >
                    <div className="text-left">
                      ...
                      <p className="text-sm opacity-80">
                        Upload via API route (limitado a ~4.5MB no Vercel). Use
                        apenas para vídeos pequenos.
                      </p>
                    </div>
                  </button>
                </div>
              ...
              {uploadMethod === "direct" && (
                <DirectCloudinaryUpload
                  ...
                  onUploadProgress={handleDirectUploadProgress}
                />
              )}
